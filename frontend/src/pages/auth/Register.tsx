        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
          <div className="flex flex-col mb-8">
            ...
            <div>
              ...
              <a href="/login" className="text-[#FF5757] hover:text-[#FF7B7B] underline transition-colors">Log in</a>
            </div>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button 
              ...
              className="w-full bg-[#FF5757] hover:bg-[#FF6B6B] disabled:bg-gray-500 disabled:cursor-not-allowed text-white font-medium py-2.5 px-4 rounded-lg transition-all duration-200"
            >
              {registerMutation.isPending ? 'Creating Account...' : 'Create Account'}
            </button>
          </form>
          <div className="mt-4 text-xs text-gray-400">
            By creating an account, I agree with Anima's <a href="#" className="text-[#FF5757] hover:text-[#FF7B7B] transition-colors">Privacy Policy</a> and <a href="#" className="text-[#FF5757] hover:text-[#FF7B7B] transition-colors">Terms of Service</a>.
          </div>
        </div>
