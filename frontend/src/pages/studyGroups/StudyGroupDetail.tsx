              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-[#242424] border border-gray-800 rounded-2xl p-6">
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 px-6 py-3 bg-gradient-to-r from-[#7FDBCA] to-[#00CC99] text-white font-medium rounded-xl hover:shadow-lg hover:shadow-[#7FDBCA]/20 transition-all duration-200">
                      Join Group
                    </button>
