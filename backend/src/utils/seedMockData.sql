-- Mock Data for Achievements and Skills
-- Run this SQL script in your PostgreSQL database to populate mock data

-- First, ensure the activity table exists (if not already created)
DO $$ BEGIN
...
CREATE TABLE IF NOT EXISTS activity (
    ...
    CONSTRAINT activity_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);
...
-- Insert mock user skill assessment results (assuming users with IDs 1-5 exist)
...
INSERT INTO activity (user_id, activity_type, target_type, metadata, created_at) VALUES
(1, 'badge_earned', 'badge', '{"badge_name": "First Steps", "badge_description": "Completed your first learning module", "badge_icon": "trophy", "points": 10}', NOW() - INTERVAL '30 days'),
(1, 'badge_earned', 'badge', '{"badge_name": "Quick Learner", "badge_description": "Completed 5 modules in one week", "badge_icon": "zap", "points": 25}', NOW() - INTERVAL '25 days'),
(1, 'badge_earned', 'badge', '{"badge_name": "Consistent Learner", "badge_description": "Maintained a 7-day learning streak", "badge_icon": "flame", "points": 20}', NOW() - INTERVAL '20 days'),
(1, 'badge_earned', 'badge', '{"badge_name": "Skill Master", "badge_description": "Achieved 90%+ on a skill assessment", "badge_icon": "star", "points": 30}', NOW() - INTERVAL '15 days'),
(2, 'badge_earned', 'badge', '{"badge_name": "First Steps", "badge_description": "Completed your first learning module", "badge_icon": "trophy", "points": 10}', NOW() - INTERVAL '25 days'),
(2, 'badge_earned', 'badge', '{"badge_name": "Social Butterfly", "badge_description": "Joined 3 study groups", "badge_icon": "users", "points": 15}', NOW() - INTERVAL '20 days'),
(2, 'badge_earned', 'badge', '{"badge_name": "Knowledge Sharer", "badge_description": "Shared 10 study notes", "badge_icon": "book-open", "points": 20}', NOW() - INTERVAL '10 days'),
(3, 'badge_earned', 'badge', '{"badge_name": "First Steps", "badge_description": "Completed your first learning module", "badge_icon": "trophy", "points": 10}', NOW() - INTERVAL '35 days'),
(3, 'badge_earned', 'badge', '{"badge_name": "Creative Mind", "badge_description": "Created your first study note", "badge_icon": "lightbulb", "points": 10}', NOW() - INTERVAL '30 days'),
(3, 'badge_earned', 'badge', '{"badge_name": "UI Enthusiast", "badge_description": "Completed UI/UX Design assessment with 90%+", "badge_icon": "palette", "points": 25}', NOW() - INTERVAL '5 days'),
(4, 'badge_earned', 'badge', '{"badge_name": "First Steps", "badge_description": "Completed your first learning module", "badge_icon": "trophy", "points": 10}', NOW() - INTERVAL '12 days'),
(4, 'badge_earned', 'badge', '{"badge_name": "DevOps Explorer", "badge_description": "Completed DevOps Fundamentals assessment", "badge_icon": "settings", "points": 20}', NOW() - INTERVAL '8 days'),
(4, 'badge_earned', 'badge', '{"badge_name": "Team Player", "badge_description": "Helped 5 fellow learners", "badge_icon": "heart", "points": 15}', NOW() - INTERVAL '6 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "First Steps", "badge_description": "Completed your first learning module", "badge_icon": "trophy", "points": 10}', NOW() - INTERVAL '40 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "Code Expert", "badge_description": "Achieved expert level in JavaScript", "badge_icon": "code", "points": 50}', NOW() - INTERVAL '35 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "Mentor", "badge_description": "Helped 20 learners in study groups", "badge_icon": "graduation-cap", "points": 40}', NOW() - INTERVAL '25 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "Streak Master", "badge_description": "Maintained a 30-day learning streak", "badge_icon": "flame", "points": 35}', NOW() - INTERVAL '20 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "TypeScript Wizard", "badge_description": "Mastered advanced TypeScript concepts", "badge_icon": "diamond", "points": 45}', NOW() - INTERVAL '18 days'),
(5, 'badge_earned', 'badge', '{"badge_name": "AI Pioneer", "badge_description": "Explored machine learning fundamentals", "badge_icon": "brain", "points": 30}', NOW() - INTERVAL '3 days');
...
-- Insert additional social and learning activities
INSERT INTO activity (user_id, activity_type, target_type, metadata, created_at) VALUES
(1, 'learning_path_created', 'learning_path', '{"path_title": "Full Stack Web Development", "module_count": 12, "difficulty": "intermediate"}', NOW() - INTERVAL '28 days'),
(1, 'study_group_created', 'study_group', '{"group_name": "React Developers", "member_count": 15}', NOW() - INTERVAL '20 days'),
(2, 'learning_path_created', 'learning_path', '{"path_title": "Data Science with Python", "module_count": 8, "difficulty": "medium"}', NOW() - INTERVAL '22 days'),
(2, 'study_group_joined', 'study_group', '{"group_name": "React Developers", "joined_by": "invitation"}', NOW() - INTERVAL '19 days'),
(3, 'learning_path_created', 'learning_path', '{"path_title": "UI/UX Design Fundamentals", "module_count": 6, "difficulty": "easy"}', NOW() - INTERVAL '32 days'),
(3, 'study_group_created', 'study_group', '{"group_name": "Design Thinkers", "member_count": 8}', NOW() - INTERVAL '25 days'),
(4, 'learning_path_created', 'learning_path', '{"path_title": "DevOps Engineering", "module_count": 10, "difficulty": "hard"}', NOW() - INTERVAL '10 days'),
(4, 'study_group_joined', 'study_group', '{"group_name": "Design Thinkers", "joined_by": "request"}', NOW() - INTERVAL '8 days'),
(5, 'learning_path_created', 'learning_path', '{"path_title": "Advanced TypeScript & Node.js", "module_count": 15, "difficulty": "hard"}', NOW() - INTERVAL '38 days'),
(5, 'study_group_created', 'study_group', '{"group_name": "TypeScript Masters", "member_count": 25}', NOW() - INTERVAL '30 days'),
(1, 'friend_added', 'user', '{"friend_name": "Jane Smith", "mutual_friend": false}', NOW() - INTERVAL '26 days'),
(2, 'friend_added', 'user', '{"friend_name": "John Doe", "mutual_friend": false}', NOW() - INTERVAL '26 days'),
(3, 'friend_added', 'user', '{"friend_name": "Bob Wilson", "mutual_friend": false}', NOW() - INTERVAL '15 days'),
(4, 'friend_added', 'user', '{"friend_name": "Alice Brown", "mutual_friend": false}', NOW() - INTERVAL '15 days'),
(5, 'friend_added', 'user', '{"friend_name": "John Doe", "mutual_friend": false}', NOW() - INTERVAL '35 days'),
(1, 'streak_achieved', 'streak', '{"streak_days": 7, "streak_type": "learning"}', NOW() - INTERVAL '20 days'),
(5, 'streak_achieved', 'streak', '{"streak_days": 30, "streak_type": "learning"}', NOW() - INTERVAL '20 days'),
(2, 'learning_path_shared', 'learning_path', '{"path_title": "Data Science with Python", "shared_with": "public"}', NOW() - INTERVAL '18 days'),
(5, 'learning_path_shared', 'learning_path', '{"path_title": "Advanced TypeScript & Node.js", "shared_with": "study_group"}', NOW() - INTERVAL '25 days');

-- Summary
SELECT
    'Skill Assessments' as category,
    COUNT(*) as count
FROM skill_assessment
UNION ALL
SELECT
    'User Skill Assessment Results' as category,
    COUNT(*) as count
FROM user_skill_assessment
UNION ALL
SELECT
    'Achievement Activities' as category,
    COUNT(*) as count
FROM activity
WHERE activity_type = 'badge_earned'
UNION ALL
SELECT
